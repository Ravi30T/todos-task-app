...
const TodoItem = props => {
  ...
  const [newTodoStatus, updateNewTodoStatus] = useState('')
  ...
  const onClickCheck = e => {
    updateNewTodoStatus(e.target.value)
  ...
  return (
    <li className='each-task'>
        ...
        <div className='task-btn-container'>
            {
                saveBtn ? <button type='button' className='edit-btn' onClick={onSaveItem}>Save</button>: <button type='button' className='edit-btn' onClick={onEditItem}>Edit</button>
            }
